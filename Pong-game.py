...
SIDE = "right"		#this variable takes care of the direction to go :D
ball_vel =[]		#not yet initialized,will be initialized once spawn_ball() is called :)
...
def draw(canvas):
    ...
    # update ball- this is the positional update for the ball
